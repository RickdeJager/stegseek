...
# -h 18 --> 18 rows
# -w 105 --> 105 char line width
# -s 10 --> 10x speedup. Should make this a 10 second gif
#
# [!] Before compiling this cast to a gif, you should go through and delete ~90% of the 
#     progress updates. Otherwise this tool will create a huge gif. When speed up by 10x
#     you won't notice any difference.
#
#     you might have to go through the cast and do some cleanup though.
#
docker run --rm -v $PWD:/data asciinema/asciicast2gif -h 18 -w 105 -s 10 -t solarized-dark seed.cast seed.gif
